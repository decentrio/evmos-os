...
func init() {
	file_os_types_v1_account_proto_init()
	md_EthAccount = File_os_types_v1_account_proto.Messages().ByName("EthAccount")
...
func (x *EthAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_os_types_v1_account_proto_msgTypes[0]
...
func (x *fastReflection_EthAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "os.types.v1.EthAccount.base_account":
		return x.BaseAccount != nil
	case "os.types.v1.EthAccount.code_hash":
		return x.CodeHash != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.types.v1.EthAccount"))
		}
		panic(fmt.Errorf("message os.types.v1.EthAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EthAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message os.types.v1.EthAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EthAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "os.types.v1.EthAccount.code_hash":
		panic(fmt.Errorf("field code_hash of message os.types.v1.EthAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.types.v1.EthAccount"))
		}
...
func (x *fastReflection_EthAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in os.types.v1.EthAccount", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EthAccount) Descriptor() ([]byte, []int) {
	return file_os_types_v1_account_proto_rawDescGZIP(), []int{0}
}
...
var File_os_types_v1_account_proto protoreflect.FileDescriptor

var file_os_types_v1_account_proto_rawDesc = []byte{
	0x0a, 0x19, 0x6f, 0x73, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6f, 0x73, 0x2e,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x49, 0x42, 0x93, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x73,
	...
	0x73, 0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6f, 0x73, 0x2f, 0x74,
	0x79, 0x70, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x3b, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0xa2,
	0x02, 0x03, 0x4f, 0x54, 0x58, 0xaa, 0x02, 0x0b, 0x4f, 0x73, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x73,
	0x2e, 0x56, 0x31, 0xca, 0x02, 0x0b, 0x4f, 0x73, 0x5c, 0x54, 0x79, 0x70, 0x65, 0x73, 0x5c, 0x56,
	0x31, 0xe2, 0x02, 0x17, 0x4f, 0x73, 0x5c, 0x54, 0x79, 0x70, 0x65, 0x73, 0x5c, 0x56, 0x31, 0x5c,
...
var (
	file_os_types_v1_account_proto_rawDescOnce sync.Once
	file_os_types_v1_account_proto_rawDescData = file_os_types_v1_account_proto_rawDesc
)

func file_os_types_v1_account_proto_rawDescGZIP() []byte {
	file_os_types_v1_account_proto_rawDescOnce.Do(func() {
		file_os_types_v1_account_proto_rawDescData = protoimpl.X.CompressGZIP(file_os_types_v1_account_proto_rawDescData)
	})
	return file_os_types_v1_account_proto_rawDescData
}

var file_os_types_v1_account_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_os_types_v1_account_proto_goTypes = []interface{}{
	(*EthAccount)(nil),          // 0: os.types.v1.EthAccount
	(*v1beta1.BaseAccount)(nil), // 1: cosmos.auth.v1beta1.BaseAccount
}
var file_os_types_v1_account_proto_depIdxs = []int32{
	1, // 0: os.types.v1.EthAccount.base_account:type_name -> cosmos.auth.v1beta1.BaseAccount
...
func init() { file_os_types_v1_account_proto_init() }
func file_os_types_v1_account_proto_init() {
	if File_os_types_v1_account_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_os_types_v1_account_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_os_types_v1_account_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_os_types_v1_account_proto_goTypes,
		DependencyIndexes: file_os_types_v1_account_proto_depIdxs,
		MessageInfos:      file_os_types_v1_account_proto_msgTypes,
	}.Build()
	File_os_types_v1_account_proto = out.File
	file_os_types_v1_account_proto_rawDesc = nil
	file_os_types_v1_account_proto_goTypes = nil
	file_os_types_v1_account_proto_depIdxs = nil
}
